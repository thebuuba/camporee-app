...
import { LockKeyhole, Mail, TentTree } from "lucide-react";
    ...
    <section className="auth-wrap">
      ...
      <section className="auth-card auth-card-ios">
        ...
        <form className="auth-form auth-form-ios">
          ...
          <label>Contraseña<div className="field-card"><span><LockKeyhole size={17}/></span><input name="password" type="password" autoComplete="current-password" placeholder="Tu contraseña" minLength={6} required /></div></label>
